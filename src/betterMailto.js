...
function initializeBetterMailto() {
  const mailtoLinks = document.querySelectorAll(
    'a[href^="mailto:"], a[data-bettermailto-username][data-bettermailto-domain]',
  );
  ...
  mailtoLinks.forEach((link) => {
    link.addEventListener('click', (event) => {
      ...
      if (
        ...
        const username = link.getAttribute('data-bettermailto-username');
        const domain = link.getAttribute('data-bettermailto-domain');
        if (username && domain) {
...
<div class="bettermailto-modal-overlay">
  <div class="bettermailto-modal">
    ...
    <div class="bettermailto-email-field">
      ...
      <button class="bettermailto-copy-btn" onclick="betterMailtoCopyToClipboard('${email}')">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
          <path
            d="M384 336H192c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16l140.1 0L400 115.9V320c0 8.8-7.2 16-16 16zM192 384H384c35.3 0 64-28.7 64-64V115.9c0-12.7-5.1-24.9-14.1-33.9L366.1 14.1c-9-9-21.2-14.1-33.9-14.1H192c-35.3 0-64 28.7-64 64V320c0 35.3 28.7 64 64 64zM64 128c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H256c35.3 0 64-28.7 64-64V416H272v32c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192c0-8.8 7.2-16 16-16H96V128H64z" />
        </svg>
        <span class="bettermailto-copy-text">Copy</span>
      </button>
    </div>
    <hr>
    </hr>
    ...
    <div class="bettermailto-options">
      <a href="mailto:${email}" class="bettermailto-btn default-client">
      ...
      <a href="https://mail.google.com/mail/?view=cm&fs=1&to=${email}" target="_blank" class="bettermailto-btn gmail">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path fill="black"
        ...
        Gmail</a>
      <a href="https://outlook.live.com/mail/0/deeplink/compose?to=${email}" target="_blank" class="bettermailto-btn outlook">
 ...
 */
function betterMailtoCopyToClipboard(text) {
  ...
  const copyButton = document.querySelector('.bettermailto-copy-btn');
  const previousText = copyButton.querySelector('.bettermailto-copy-text').textContent;

  // Update the text content of the button to display the feedback message
  copyButton.querySelector('.bettermailto-copy-text').textContent = 'Copied!';

  // Restore the previous text content after a short delay
  setTimeout(() => {
    copyButton.querySelector('.bettermailto-copy-text').textContent = previousText;
  }, 1500);
}
